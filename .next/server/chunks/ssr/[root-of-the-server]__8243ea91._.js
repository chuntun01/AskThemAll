...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$chat$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store/chat.js [app-ssr] (ecmascript)"); // 👈 dùng store chung
"use client";
;
;
;
...
function Home() {
    ...
    const { messages, setMessages, addMessage, selectedModelIds, setSelectedModelIds } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$chat$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChatStore"])();
    ...
    const selectedModels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return selectedModelIds.map((id)=>byId.get(id)).filter(Boolean);
    }, [
        availableModels,
        selectedModelIds
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const validIds = new Set(availableModels.map((m)=>m.modelId));
        const filtered = selectedModelIds.filter((id)=>validIds.has(id));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8243ea91._.js.map